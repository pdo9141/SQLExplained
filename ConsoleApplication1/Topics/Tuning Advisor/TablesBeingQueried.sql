...
LEFT JOIN sys.dm_db_index_usage_stats AS us ON us.[object_id] = T.[object_id] AND us.database_id = DB_ID()
LEFT JOIN (
	SELECT 
		MAX(up.last_user_read) AS 'last_read'
